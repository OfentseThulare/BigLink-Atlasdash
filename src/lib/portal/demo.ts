...
export const demoInvoices: InvoiceView[] = [
  {
    ...
    description: "Referral advisory services for external project",
  ...
  },
  {
    ...
    number: "BL-SVC-018",
    client: "Big Link Consulting",
    description: "Direct service obligation for partnership support",
  ...
  },
  {
    ...
    number: "AT-INV-090",
    client: "Northstar Holdings",
    description: "Joint campaign build and performance review",
    kind: "Referral commission source",
